...
<div class="container">
    ...
    <div class="mb-3">
        <p><strong>Llegada:</strong> <?php echo e($reserva->Fecha_Llegada->format('d-m-Y')); ?></p>
        <p><strong>Salida:</strong> <?php echo e($reserva->Fecha_Salida->format('d-m-Y')); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProyectoFCT\laragon\www\roomeo\resources\views/reservas/show.blade.php ENDPATH**/ ?>