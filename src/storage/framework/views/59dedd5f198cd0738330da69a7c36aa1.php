...
<div class="container">
    ...
    <form method="POST" action="<?php echo e(route('tipohabitaciones.store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProyectoFCT\laragon\www\roomeo\resources\views/tipo_habitaciones/create.blade.php ENDPATH**/ ?>