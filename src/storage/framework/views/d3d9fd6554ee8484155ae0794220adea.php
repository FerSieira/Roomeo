...
<div class="container">
    ...
    <form method="POST" action="<?php echo e(route('reserva_servicios.store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
            ...
            <select class="form-control" id="ID_Reserva" name="ID_Reserva" required>
                <?php $__currentLoopData = $reservas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reserva): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($reserva->ID_Reservas); ?>"><?php echo e($reserva->ID_Reservas); ?></option>
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="ID_Servicio" name="ID_Servicio" required>
                <?php $__currentLoopData = $servicios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servicio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($servicio->ID_Servicio); ?>"><?php echo e($servicio->Nombre); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ProyectoFCT\laragon\www\roomeo\resources\views/reserva_servicios/create.blade.php ENDPATH**/ ?>