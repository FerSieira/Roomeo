    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo e(route('habitaciones.edit', $habitacion->ID_Habitacion)); ?>" class="btn btn-info">Editar</a>
                    <form action="<?php echo e(route('habitaciones.destroy', $habitacion->ID_Habitacion)); ?>" method="POST" style="display:inline;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Fernando\Desktop\ProyectoPMS\laragon\www\roomeo\resources\views/habitaciones/index.blade.php ENDPATH**/ ?>